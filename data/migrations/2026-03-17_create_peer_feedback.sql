...
BEGIN
    CREATE TABLE dbo.peer_feedback (
        ...
        CONSTRAINT FK_peer_feedback_group FOREIGN KEY (group_id) REFERENCES dbo.study_groups(id),
        CONSTRAINT FK_peer_feedback_session FOREIGN KEY (session_id) REFERENCES dbo.study_sessions(id),
